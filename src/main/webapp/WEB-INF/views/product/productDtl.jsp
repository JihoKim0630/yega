...
<body>
    ...
    <section class="bg-light">
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="${prodDtl.prodMainImg.imgPath}" alt="Card image cap" id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2"></h1>
                            <p class="h3 py-2">${prodDtl.prodPrice}원</p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>${prodDtl.mnfcCompny}</strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>색상 컬럼도 추가 해야 할까?</strong></p>
                                </li>
                            </ul>
        ...
        <div class="card mb-3">
        	<c:forEach var="i" items="${prodDtl.prodImgList}" varStatus="vs">
	           <img class="card-img img-fluid" src="${i.imgPath}" alt="Card image cap" id="product-detail">
